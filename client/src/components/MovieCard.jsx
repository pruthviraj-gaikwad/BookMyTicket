...
const MovieCard = ({ movie }) => {
    ...
    return (
        <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 transition duration-300 w-66 shadow-md'>
            ...
            <div className='flex items-center justify-between mt-4 pb-3'>
                <button onClick={() => { navigate(`/movies/${movie._id}`); scrollTo(0, 0) }}
                    ...
                    style={{
                        ...
                        color: 'white'
                    }} className='flex items-center gap-1 px-6 py-3 text-sm transition rounded-full font-medium cursor-pointer'>Buy Tickets</button>
